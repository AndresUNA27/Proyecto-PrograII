...
//imports de las diferentes clases
...
//clase controlador para llamar a las listas
public class Controlador {
    ...
    public Controlador(PrincipalView pVista) {
        ...
        Type tipo = new TypeToken<ArrayList<Universidad>>() {
        }.getType();
    ...
    public void agregarControlador() {
        ...
        actionListenerVerInformacionUniversidad();
    ...
    public void actionListenerAgregarUnis() {
        ...
        // Cambia al panel para gestionar a los estudiantes
    ...
    // Metodo para los action listener del panel para ver la informacion de una universidad
    public void actionListenerVerInformacionUniversidad() {
        this.varPrincipal.btnMostrarUni.addActionListener(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent p) {
                        mostrarInformacionUniversidad(varPrincipal.txtNombreMostrarUni.getText());
                    }
                });

        this.varPrincipal.btnVolverAgregarUniDesdeMostrarUni.addActionListener(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent p) {
    ...
    public void actionListenerModificarUnis() {
        ...
        this.varPrincipal.btnIrMostrarUni.addActionListener(
                new ActionListener() {

                    @Override
                    public void actionPerformed(ActionEvent p) {
                        varPrincipal.layout.show(varPrincipal.panelContenedor, "mostrarUniversidad");
                    }
                });
    ...
    public void actionListenerAgregarEscuela() {
        ...
        // Metodo para agregar una nueva escuela a una universidad
        ...
        // Cambia al panel de consultar la lista de escuelas de una universidad
    ...
    public void actionListenerAgregarCursos() {
        // Metodo para validar el nombre del curso
        ...
        // Llama al metodo para volver a buscar una universidad a la cual añadir nuevos cursos
        ...
        // Llama al metodo para agregar un nuevo curso en una escuela
...
//action listener para el combobox de las escuelas
    ...
    //actions listeners para los botones
    ...
    public void actionListenerModificarInformacionEstudiante() {
        ...
        varPrincipal.btnModificarEstudiante.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                varPrincipal.getCbCantidadBecaModificarEstudiante().setSelectedIndex(0);
                varPrincipal.getCbCantidadBecaModificarEstudiante().setEnabled(false);

            }
        });

        varPrincipal.cbNacionalidadEstudianteModificarEstudiante.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    String seleccion = (String) varPrincipal.cbNacionalidadEstudianteModificarEstudiante.getSelectedItem();
                    boolean esNacional = "Nacional".equals(seleccion);
                    varPrincipal.getCbCantidadBecaModificarEstudiante().setEnabled(esNacional);
                }
            }
        });
    ...
    public void actionListenerMatricularEstudiante() {
        ...
        this.varPrincipal.cbListaCursos2.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    Estudiante estudianteSeleccionado = (Estudiante) varPrincipal.cbListaEstudiantes.getSelectedItem();
                    Curso cursoSeleccionado = (Curso) varPrincipal.cbListaCursos2.getSelectedItem();
                    if (cursoSeleccionado != null) {
                        mostrarGruposDelCursoMatricularEstudiantes(estudianteSeleccionado, cursoSeleccionado);
                    }
                }
            }
        });
    ...
    //action listener para el calculo de los aranceles
    ...
    public void actionListenerConsultaGeneralEstudiantil() {
        this.varPrincipal.btnMostrarGrupos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                mostrarGrupos();
            }
        ...
        this.varPrincipal.btnConsultaGeneralEstudianteLista.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String varSiglaCurso = JOptionPane.showInputDialog(null, "Escriba la sigla del grupo: ");
                ...
                switch (varOption) {
                    ...
                    case "Todos los estudiantes por curso":
                        resultado = obtenerListaCursosPorEstudiante(varSiglaCurso);
                        break;
                }

                varPrincipal.jtaMostrarConsultaGeneralEstudiantes.setText(resultado);
    ...
    public void mostrarInformacionUniversidad(String pNameU) {
        Universidad u = buscarUniversidadConNombre(pNameU);
        if (u != null) {
            varPrincipal.jtaMostrarUni.setText(u.toString());
        }
    }
    ...
    // Metodo que valida y muestra los nombres de las escuelas vinculadas a una universidad
    ...
    // Metodo para buscar la universidad donde se guardaran los nuevos cursos
    ...
    //encontrar y mostrar el curso por sigla
    ...
    //Eliminar el curso por la sigla
    public void eliminarCursoPorSigla(String sigla) {
        ...
        for (Universidad u : varListaUnis) {
            for (Escuela esc : u.getEscuelas()) {
                Curso curso = esc.getCursoConSigla(sigla);
                if (curso != null) {
                    borrarTodoConRelacionAlCurso(curso);
                    esc.getCursos().remove(curso);// Aqui eliminamos el curso
    ...
    /* Metodo para desasignar, de un profesor, los grupos que se van a eliminar junto al curso. Además de quitar
    los creditos del curso a los estudiantes que hayan matriculado el curso */
    public void borrarTodoConRelacionAlCurso(Curso curso) {
        for (Grupo g : curso.getGruposDelCurso()) {
            g.setCursoPertenece(null);
            g.setProfesorPertenece(null);

            List<EstudianteNacional> copiaNacionales = new ArrayList<>(g.getEstudiantesNacionalesDelCurso());
            for (EstudianteNacional en : copiaNacionales) {
                en.quitarCreditos(curso.getCreditos());
                g.eliminarEstudiante(en);
            }

            List<EstudianteExtranjero> copiaExtranjeros = new ArrayList<>(g.getEstudiantesExtranjerosDelCurso());
            for (EstudianteExtranjero ee : copiaExtranjeros) {
                ee.quitarCreditos(curso.getCreditos());
                g.eliminarEstudiante(ee);
            }
        }
        Set<Grupo> gruposDelCurso = new HashSet<>(curso.getGruposDelCurso());
        for (Universidad u : varListaUnis) {
            for (Escuela e : u.getEscuelas()) {
                for (Profesor p : e.getProfesores()) {
                    List<Grupo> copiaGrupos = new ArrayList<>(p.obtenerGruposImpartidos());
                    for (Grupo g : copiaGrupos) {
                        if (gruposDelCurso.contains(g)) {
                            p.desasignarProfesorAGrupo(g);
                        }
                    }
                }
            }
    ...
    //buscar la universidad para agregar el grupo
    ...
    public void agregarGrupoACurso(String pNombreEscuela, String pNombreCurso, String pSiglaGrupo) {
        ...
        Grupo grupo = new Grupo(pSiglaGrupo, c.getSigla(), null);
...
//    }
    ...
    public void agregarProfesor(String pEscuela, String pUni, String pNumCed, String pNombreProfesor, String pApellido1, String pApellido2) {
        try {
            ...
            // Valida que no haya un estudiante nacional con el numero de cedula escrito para el profesor
            for (Estudiante e : u.getEstudiantesExtranjerosDelCurso()) {
                if (e.getNumeroCedulaEstudiante() == numCedula) {
                    JOptionPane.showMessageDialog(null, "Ya hay un estudiante con ese numero de cedula...");
                    return;
                }
            }

            // Valida que no haya un estudiante extranjero con el numero de cedula escrito para el profesor
            for (Estudiante e : u.getEstudiantesNacionalesDelCurso()) {
                if (e.getNumeroCedulaEstudiante() == numCedula) {
                    JOptionPane.showMessageDialog(null, "Ya hay un estudiante con ese numero de cedula...");
                    return;
                }
    ...
    //Validar el nombre de la universidad para modificar al profesor
    ...
    //Encontrar el profesor con la cedula para modificar el profesor
    ...
    //Validar la universidad para mostrar la informacion del profesor
    ...
    //Encontrar profesor para mostrar la info del profesor
    ...
    //Para buscar un profesor en otra uni
    ...
    //Mostrar la lista de los profes por escuela
    ...
    //Mostrar la lista de los profes
    ...
    //Mostrar la lista de los profes (de otra U)
    ...
    //Mostrar la lista de cursos, profesores por escuela
    ...
    //Mostrar la lista de grupos por curso
...
//validando si se a seleccionado profesor,curso o grupo
        if (profesorSeleccionado == null) {
        ...
        if (grupoSeleccionado.getProfesorPertenece() != null) {
            JOptionPane.showMessageDialog(null, "Este grupo ya tiene un profesor asignado...");
            return;
        }

        // Ahora profesorPertenece es un ID (por ejemplo int cedula),
        // revisamos si tiene profesor asignado con una condición diferente:
        if (grupoSeleccionado.getProfesorPertenece() != null) { // o null si es Integer
            JOptionPane.showMessageDialog(null, "Este grupo ya se le fue asignado a otro profesor...");
            return;
        }

        profesorSeleccionado.asignarProfesorAGrupo(grupoSeleccionado);

        // Guardar solo la cédula del profesor en el grupo
        Integer numCedProfeGrupo = Integer.valueOf(profesorSeleccionado.getNumeroCedula());
        grupoSeleccionado.setProfesorPertenece(numCedProfeGrupo);
    ...
    //Desagsinar profesor de un curso
...
//validando si se a seleccionado profesor,curso o grupo
        ...
        if (cursoSeleccionado == null) {
            JOptionPane.showMessageDialog(null, "No se ha seleccionado ningún curso, por favor seleccione uno...");
            return;
        }
        if (grupoSeleccionado == null) {
        ...
        //Integer in = Integer.valueOf(profesorSeleccionado.getNumeroCedula());
        if ((grupoSeleccionado.getProfesorPertenece()).equals(Integer.valueOf(profesorSeleccionado.getNumeroCedula()))) {
            profesorSeleccionado.desasignarProfesorAGrupo(grupoSeleccionado);
    ...
    //mostrar los cursos asignados a un profesor
        ...
        for (Escuela e : pNombreU.getEscuelas()) {
            for (Profesor p : e.getProfesores()) {
                if (p.getNumeroCedula() == idProfe) {
                    List<Grupo> grupos = p.obtenerGruposImpartidos();
                    if (grupos.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "No se ha asignado ningun grupo a este profesor...");
                        return;
                    }
                    StringBuilder texto = new StringBuilder("Cursos asignados al profesor " + p.getNombre() + ":\n");
                    for (Grupo c : grupos) {
                        texto.append("-").append(c.getSiglaGrupo()).append("\n");
                    }
    ...
    //buscar el profesor por la cedula
    public Profesor buscarProfesorPorCedula(int cedula) {
        for (Profesor p : varListaProfesores) {
    ...
    //obtener la lista de cursos por profesor para mostrar
    public String obtenerListaCursoConProfesor(ArrayList<Grupo> grupos) {
        if (grupos == null || grupos.isEmpty()) {
            return "No hay grupos registrados para este curso.";
        }
        ...
        for (Grupo grupo : grupos) {
            String siglaCurso = grupo.getCursoPertenece();
            for (Universidad u : varListaUnis) {
                for (Escuela e : u.getEscuelas()) {
                    c = e.getCursoConSigla(siglaCurso);
                }
            }
            Curso curso = c;

            Integer cedulaProfe2 = grupo.getProfesorPertenece();
            for (Universidad u : varListaUnis) {
                for (Escuela e : u.getEscuelas()) {
                    p = e.getProfesorConCedula(cedulaProfe2);
                }
            }
            Profesor profesor = p;
    ...
    public String obtenerListaProfesoresPorCurso(String pSiglaCurso, ArrayList<Grupo> grupos) {
        ...
        Profesor p = new Profesor();
        for (Grupo grupo : grupos) {
            if (grupo.getCursoPertenece().equalsIgnoreCase(pSiglaCurso)) {
                Integer cedulaProfesor = grupo.getProfesorPertenece();
                for (Universidad u : varListaUnis) {
                    for (Escuela e : u.getEscuelas()) {
                        p = e.getProfesorConCedula(cedulaProfesor);
                    }
                }
    ...
    public String obtenerListaEscuelasCursoYProfesores(ArrayList<Escuela> escuelas, ArrayList<Grupo> grupos) {
        ...
        for (Escuela escuela : escuelas) {
            ...
            for (Grupo grupo : grupos) {
                String siglaCurso = grupo.getCursoPertenece();
                Curso curso = escuela.getCursoConSigla(siglaCurso);
                if (curso != null && curso.getEscuelaPertenece().equalsIgnoreCase(escuela.getVarSchoolName())) {
                    Integer cedulaProfesor = grupo.getProfesorPertenece();
    ...
    //Buscar universidad para agregar al estudiante
...
//Agregar al estudiante
    public void agregarEstudiante(String pNumCed, String pNumCarnet, String pNombreEst, String pApellido1, String pApellido2, String pNacionalidad, String pCantidadBeca) {
        try {
            ...
            for (Escuela e : u.getEscuelas()) {
                if (e.getProfesorConCedula(numeroCedula) != null) {
                    JOptionPane.showMessageDialog(null, "Hay un profesor con ese numero de cedula...");
                    return;
                }
            }
//validar para la cantidad de beca dependiendo de la nacionalidad
            if (pNacionalidad == "Nacional") {
                ...
                beca = (beca / 100);
                EstudianteNacional p = new EstudianteNacional(numeroCedula, numeroCarnet, pNombreEst, pApellido1, pApellido2, "Nacional", beca, 0);
                u.agregarEstudianteNacional(p);
                JsonManager.guardar("universidades.json", varListaUnis);

                JOptionPane.showMessageDialog(null, "Estudiante nacional agregado a la " + u.getVarNameU() + "!!!");
            } else {
                EstudianteExtranjero p = new EstudianteExtranjero(numeroCedula, numeroCarnet, pNombreEst, pApellido1, pApellido2, "Extranjero", 0);
    ...
    //buscar la universidad para mostrar los estudiantes
    ...
    //buscar al estudiante por la cedula o carnet para modificar
    public void buscarEstudianteConCedulaCarnetModificarEstudiante(String pCedulaCarnet) {
        try {
            ...
            int cedulaCarnet = Integer.parseInt(pCedulaCarnet); //integer para envolverlo y un parseo para pasar de una cadena a String

            //si se encuentra, habilitar las funciones para agregar (tanto nacional como extranjero)
...
//si se encuentra, habilitar las funciones para agregar (tanto nacional como extranjero)
        ...
        if (estNaCambiarNacionalidad != null) {
            if (varPrincipal.cbNacionalidadEstudianteModificarEstudiante.getSelectedItem().equals("Nacional")) {
                ...
                EstudianteExtranjero estudianteExtranjero = new EstudianteExtranjero(estNaCambiarNacionalidad.getNumeroCedulaEstudiante(),
                        ...
                        varPrincipal.txtApellido2ModificarEstudiante.getText(), "Extranjero", (int) estNaCambiarNacionalidad.getCantidaCreditosMatriculados());
        ...
        if (estExCambiarNacionalidad != null) {
            if (varPrincipal.cbNacionalidadEstudianteModificarEstudiante.getSelectedItem().equals("Extranjero")) {
                ...
                EstudianteNacional estudianteNacional = new EstudianteNacional(estExCambiarNacionalidad.getNumeroCedulaEstudiante(),
                        ...
                        varPrincipal.txtApellido2ModificarEstudiante.getText(), "Nacional", 0.0, (int) estExCambiarNacionalidad.getCantidaCreditosMatriculados());
    ...
    //Para modificar otro estudiante
    ...
    //mostrara la lista de los estudiantes junto con los cursos
    public void mostrarLisaEstudiantesYCursos(String pNombreU) {
        Universidad u = buscarUniversidadConNombre(pNombreU);
        if (u != null) {
            if (u.getEscuelas().isEmpty()) {
                JOptionPane.showMessageDialog(null, "No hay escuelas agregadas a la universidad aun, por ende, no hay cursos ni grupos que mostrar...");
                return;
            } else if (u.getEstudiantesNacionalesDelCurso().isEmpty() && u.getEstudiantesExtranjerosDelCurso().isEmpty()) {
                JOptionPane.showMessageDialog(null, "No hay estudiantes agregado a la universidad...");
                return;
            } else if (u.getEstudiantesExtranjerosDelCurso().isEmpty() || u.getEstudiantesNacionalesDelCurso().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Deben haber estudiantes tanto nacionales como extranjeros..");
                return;
            }
            ...
            for (Escuela e : u.getEscuelas()) {
                if (e.getCursos().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "No hay cursos agregados a la escuela " + e.getVarSchoolName() + " ,agregue uno para mostrarlo...");
                    varPrincipal.cbListaCursos2.removeAllItems();
                    varPrincipal.cbGruposDelCurso2.removeAllItems();
                    return;
                }
                for (Curso c : e.getCursos()) {
            ...
            Curso cu = (Curso) varPrincipal.cbListaCursos2.getSelectedItem();

            if (cu.getGruposDelCurso().isEmpty()) {
                JOptionPane.showMessageDialog(null, "No hay grupos agregados al curso, aguege uno para matricular un estudiante en él...");
                varPrincipal.cbListaCursos2.removeAllItems();
                return;
            }

            varPrincipal.cbListaEstudiantes.removeAllItems();
            for (EstudianteNacional en : u.getEstudiantesNacionalesDelCurso()) {
                varPrincipal.cbListaEstudiantes.addItem(en);
            }
            for (EstudianteExtranjero ee : u.getEstudiantesExtranjerosDelCurso()) {
                varPrincipal.cbListaEstudiantes.addItem(ee);
            }
            return;
        }
        varPrincipal.cbListaEstudiantes.removeAllItems();
    ...
    public void mostrarGruposDelCursoMatricularEstudiantes(Estudiante pEstudianteSeleccionado, Curso pCursoSeleccionado) {
        Estudiante e = pEstudianteSeleccionado;
        Curso c = pCursoSeleccionado;
        Universidad u = buscarUniversidadConNombre(varPrincipal.txtBuscarUMatriculaEstudiante.getText());

        if (c.getGruposDelCurso().isEmpty()) {
            JOptionPane.showMessageDialog(null, "No hay grupos agregados al curso, agregue uno para matricular un estudiante en él...");
            varPrincipal.cbGruposDelCurso2.removeAllItems();
            return;
        }
        varPrincipal.cbGruposDelCurso2.removeAllItems();
        for (Grupo g : c.getGruposDelCurso()) {
            if (g != null) {
                varPrincipal.cbGruposDelCurso2.addItem(g);
            }
        }
    }
    ...
    public void matricularEstudiante() {
        Estudiante estudianteSeleccionado = (Estudiante) varPrincipal.cbListaEstudiantes.getSelectedItem();
        Curso cursoSeleccionado = (Curso) varPrincipal.cbListaCursos2.getSelectedItem();
        Grupo grupoSeleccionado = (Grupo) varPrincipal.cbGruposDelCurso2.getSelectedItem();

        if (grupoSeleccionado == null || cursoSeleccionado == null || estudianteSeleccionado == null) {
            JOptionPane.showMessageDialog(null, "No se ha seleciona las opciones necesarias, vuelva a intentarlo...");
            return;
        }

        for (Grupo g : cursoSeleccionado.getGruposDelCurso()) {
            if (g.saberSiEstudianteEstaMatriculado(estudianteSeleccionado) == true) {
                JOptionPane.showMessageDialog(null, "El estudiante ya se encuentra matriculado en un grupo de este curso...");
                return;
            }
        }

        int creditosCursoEstudiante = cursoSeleccionado.getCreditos();
        estudianteSeleccionado.agregarCreditos(creditosCursoEstudiante);
        grupoSeleccionado.agregarEstudiante(estudianteSeleccionado);
        JsonManager.guardar("universidades.json", varListaUnis);
        JOptionPane.showMessageDialog(null, "Estudiante matriculado exitosamente a el curso: " + cursoSeleccionado.getNombre() + "y el grupo: " + grupoSeleccionado.getSiglaGrupo() + "!!!");
        return;
    }
    ...
    public void desMatricularEstudiante() {
        ...
        if (estudianteSeleccionado == null || cursoSeleccionado == null || grupoSeleccionado == null) {
            JOptionPane.showMessageDialog(null, "No se ha seleccionado las opciones necesarias, vuelva a intentarlo...");
            return;
        }

        if (!grupoSeleccionado.saberSiEstudianteEstaMatriculado(estudianteSeleccionado)) {
            JOptionPane.showMessageDialog(null, "El estudiante no está matriculado en este grupo....");
            return;
        }

        grupoSeleccionado.eliminarEstudiante(estudianteSeleccionado);
        int creditosAQuitar = cursoSeleccionado.getCreditos();
        estudianteSeleccionado.quitarCreditos(creditosAQuitar);
        JsonManager.guardar("universidades.json", varListaUnis);
        JOptionPane.showMessageDialog(null, "Estudiante desmatriculado exitosamente del curso: "
                + cursoSeleccionado.getNombre() + ", grupo: " + grupoSeleccionado.getSiglaGrupo() + "!!!");
    }

    //  Calculo de aranceles
    // no quieres arrglarlo? jaaj xd lol. No sé si estan hablando, no los escucho por tremendo aguacero que hay D:
    //me lo acaban de escribir?? JAJAJSJAJSJAJJA, no vi AAAAA
    // Un proyecto increible ngl

    public void calculoAranceles(String pNombreU, String IdEstudiante) {
        if (IdEstudiante.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "No se ha escrito ninguna cedula del estudiante, vuelva a intentarlo...");
            return;
        }
        ...
        if (u != null) {
            ...
            for (EstudianteNacional e : u.getEstudiantesNacionalesDelCurso()) {
                if (String.valueOf(e.getNumeroCedulaEstudiante()).equals(IdEstudiante)) {
                    aranceles += e.calculoDeArancelesCurso();
                    JsonManager.guardar("universidades.json", varListaUnis);
            ...
            for (EstudianteExtranjero e : u.getEstudiantesExtranjerosDelCurso()) {
                if (String.valueOf(e.getNumeroCedulaEstudiante()).equals(IdEstudiante)) {
                    aranceles += e.calculoArancelCurso();
                    JsonManager.guardar("universidades.json", varListaUnis);
    ...
    public String obtenerEstudiantesNacionalPorCurso(String siglaGrupo) {
        for (Universidad u : varListaUnis) {
            for (Escuela esc : u.getEscuelas()) {
                for (Curso curso : esc.getCursos()) {
                    for (Grupo grupo : curso.getGruposDelCurso()) {
                        if (grupo.getSiglaGrupo().equalsIgnoreCase(siglaGrupo)) {
                            StringBuilder sb = new StringBuilder();
                            sb.append("Grupo: ").append(grupo.getSiglaGrupo()).append("\n");
                            sb.append("Curso: ").append(curso.getSigla()).append(" - ").append(curso.getNombre()).append("\n");
                            //sb.append("---Estudiantes nacionales---\n");
                            for (EstudianteNacional na : grupo.getEstudiantesNacionalesDelCurso()) {
                                sb.append(na).append("\n");
                            }
                            return sb.toString();
                        }
        ...
        return "No se encontró el grupo con sigla: " + siglaGrupo;
    }


    //metodo de obtener lista de estudiantes extranjeros por curso:
    public String obtenerEstudianteExtranjeroPorCurso(String siglaGrupo) {
        for (Universidad u : varListaUnis) {
            for (Escuela esc : u.getEscuelas()) {
                for (Curso curso : esc.getCursos()) {
                    for (Grupo grupo : curso.getGruposDelCurso()) {
                        if (grupo.getSiglaGrupo().equalsIgnoreCase(siglaGrupo)) {
                            ...
                            for (EstudianteExtranjero ex : grupo.getEstudiantesExtranjerosDelCurso()) {
                                sb.append(ex).append("\n");
                            }
                            return sb.toString();
                        }
    ...
    public String obtenerListaCursosPorEstudiante(String siglaGrupo) {
        for (Universidad u : varListaUnis) {
            for (Escuela esc : u.getEscuelas()) {
                for (Curso curso : esc.getCursos()) {
                    for (Grupo grupo : curso.getGruposDelCurso()) {
    ...
    public void mostrarGrupos() {
        for (Universidad u : varListaUnis) {
            for (Escuela esc : u.getEscuelas()) {
                for (Curso curso : esc.getCursos()) {
                    for (Grupo grupo : curso.getGruposDelCurso()) {
                        varPrincipal.jtaMostrarGrupos.append(grupo.toString());
                        varPrincipal.jtaMostrarGrupos.append("\n");
                        varPrincipal.jtaMostrarGrupos.append("siguiente curso");
                    }
                }
            }
        }
    ...
    //Limpia campos de cada componenente del panel
    ...
    public void limpiarCamposMatricularCursos(){
        this.varPrincipal.cbGruposDelCurso2.addItem(null);
    }
